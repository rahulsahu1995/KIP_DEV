...
<section class="span<?php echo $SPAN[1];?>">
	<?php if ($success) { ?>
		<div class="success">
			<?php echo $success; ?>
			<img src="catalog/view/theme/<?php echo $themeName;?>/image/close.png" alt="" class="close" />
		</div>
	<?php } ?>
		...
		<table class="compare-info table">
			...
			<tbody>
				...
				<tr>
					...
					<?php foreach ($products as $product) { ?>
					<td><img src="catalog/view/theme/<?php echo $themeName;?>/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
