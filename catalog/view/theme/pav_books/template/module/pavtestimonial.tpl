						...
						<div class="testimonial">
							<div class="description">
								...
								<?php if( $testimonial['video_link']) { ?>
									<a class="colorbox-t color" href="<?php echo $testimonial['video_link'];?>"><?php echo $this->language->get('text_watch_video_testimonial');?></a>
								<?php } ?>
							</div>
						</div>
						<?php } ?>
						<div class="t-avatar pull-right">
							<img src="<?php echo $testimonial['thumb']; ?>" class="img-circle pull-left"/>							
