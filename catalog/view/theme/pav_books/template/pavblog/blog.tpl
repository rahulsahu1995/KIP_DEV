...
<section class="span<?php echo $SPAN[1];?>">
	...
	<div id="content" class="blog one-page">
		...
		<div class="pav-blog wrapper">
			<?php if( $blog['thumb_large'] ) { ?>
				<div class="image blog-image">
					<img src="<?php echo $blog['thumb_large'];?>" title="<?php echo $blog['title'];?>" alt="" />
				</div>
			<?php } ?>
			
			<div class="blog-meta">			
				<?php if( $config->get('blog_show_author') ) { ?>
					<span class="author color"><span><?php echo $this->language->get("text_write_by");?></span> <?php echo $blog['author'];?></span>
				<?php } ?>
			...
			<div class="blog-description">
				<div class="description no-bold clearfix"><?php echo $description;?></div>	
				...
				<div class="blog-bottom clearfix">
					...
					<div class="pavcol2">
						...
						<ul class="blog-related">
							...
							<li>
								<a href="<?php echo $this->url->link('pavblog/blog',"id=".$item['blog_id']);?>">
					...
					<?php if( count($comments) ) { ?>
						...
						<form action="<?php echo $comment_action;?>" method="post" id="comment-form">
							...
							<div class="buttons-wrap">
								<button class="btn button btn-submit" type="submit">
