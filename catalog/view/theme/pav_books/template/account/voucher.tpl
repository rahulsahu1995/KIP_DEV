...
<section class="span<?php echo $SPAN[1];?>">
	<div id="content" class="voucher one-page">
				...
				<div class="form wrapper clearfix">
					<table class="form table no-border">
						<tr>
							...
							<td>
								<input type="text" name="to_name" value="<?php echo $to_name; ?>" class="span8" />
						...
						<tr>
							...
							<td>
								<input type="text" name="to_email" value="<?php echo $to_email; ?>" class="span8" />
						...
						<tr>
							...
							<td>
								<input type="text" name="from_name" value="<?php echo $from_name; ?>" class="span8" />
						...
						<tr>
							...
							<td>
								<input type="text" name="from_email" value="<?php echo $from_email; ?>" class="span8" />
						...
						<tr>
							...
							<td>
								<textarea name="message" cols="40" rows="5" class="span8"><?php echo $message; ?></textarea>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" name="amount" value="<?php echo $amount; ?>" size="5" class="span8" />
								<?php if ($error_amount) { ?>
