...
<section class="span<?php echo $SPAN[1];?>">
	<div id="content" class="resgister one-page">	
				...
				<div class="content wrapper">
					<table class="form table no-border">
						<tr>
							...
							<td>
								<input type="text" name="company" value="<?php echo $company; ?>" class="span8" />
							</td>
						</tr>        
						...
						<tr id="company-id-display">
							...
							<td>
								<input type="text" name="company_id" value="<?php echo $company_id; ?>" class="span8" />
						...
						<tr id="tax-id-display">
							...
							<td>
								<input type="text" name="tax_id" value="<?php echo $tax_id; ?>" class="span8" />
								<?php if ($error_tax_id) { ?>
